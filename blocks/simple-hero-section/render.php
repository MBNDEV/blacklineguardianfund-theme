...
$wrapper_attrs = get_block_wrapper_attributes(
  array(
	  'class' => 'simple-hero-section relative w-full py-20 md:py-28 lg:py-32 overflow-hidden',
	  'style' => $section_style,
	  'id'    => $block_id,
  )
);
...
<section <?php echo $wrapper_attrs; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
	<div class="container mx-auto px-6 md:px-12 lg:px-16 max-w-6xl">
		...
		<div class="text-center relative z-10">
			...
			<?php if ( $subtitle ) : ?>
				<!-- Subtitle -->
				<p class="font-sofia text-gold text-lg md:text-2xl font-bold tracking-[0.2em] uppercase">
			...
			<?php if ( $heading ) : ?>
				<!-- Main heading -->
				<h1 class="font-sofia text-4xl sm:text-5xl lg:text-7xl font-bold leading-[1.1] tracking-tight text-white mb-6">
			...
			<div class="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 lg:gap-16">
				...
				<?php if ( $email ) : ?>
					...
					<div class="flex items-center gap-4">
						...
						<a href="mailto:<?php echo esc_attr( $email ); ?>" class="font-inter text-white/60 text-base md:text-lg underline hover:text-gold transition-colors duration-200">
